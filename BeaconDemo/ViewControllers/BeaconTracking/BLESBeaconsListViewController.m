//
//  BLESBeaconsListViewController.m
//  BeaconDemo
//
...
@interface BLESBeaconsListViewController ()

@end

@implementation BLESBeaconsListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SWARMBeaconCell  *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    [cell setMyBeacon:[beaconsArray objectAtIndex:[indexPath row]]];
    // Configure the cell...
    [cell updateLabels];
    return cell;
}
...
{
    if (beaconContainer!=nil) {
        [self setBeaconsArray:[beaconContainer getBeacons]];
        [self.tableView reloadData];
    }
}
