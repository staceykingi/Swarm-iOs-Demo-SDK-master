...
@interface SWARMActionsNearTVC () <CampaignsRequestCompleteDelegate>
...
@implementation SWARMActionsNearTVC
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *coupons = [[NSMutableArray alloc]init];// [restApi getMyCoupons];
